...
"""
# Network parameters
N = 1000  # mumber of nodes
K = 2  # number of layers
overlap = 0  # proportion of edge overlap between layers; only 0 and 1 are supported here

# Degree distribution parameters
mu_in = 0.5  # mu parameter of the lognormal distribution for generating the in-degree sequence
