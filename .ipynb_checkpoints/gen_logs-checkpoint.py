...
print('Number of CPU cores available: %d\n' % multiprocessing.cpu_count())
...
gamma = 2  # <W> recovery rate in the SIR process
epsilon_max = 0  # <W> maximum layer mixing
ratio = 100  # cascade-edge ratio that controls the number of cascades to generate:
	# the code will generate ratio * E cascades, where E is the number of edges in the aggregated single layer network
T = 10  # ending time
...
print('%d nodes, %d edges in the aggregated network\n' % (N, E))
C = ratio * E
